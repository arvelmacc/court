...
function showMessage(response) {
    if (response === "No") {
        ...
        if(noClickCount <= 5){
            ...
            "Told ya, please be my lovie forever ˙◠˙";
            ...
            questionElement.textContent =  "Okay, lovie, sorry for insisting so much. Of course I respect your boundaries and I'm sorry if I was being too pushy. I hope you have a fantastic day! And don't forget to drink water 🥛"
    ...
    if (response === "Yes") {
        ...
        yesMessage.textContent = "YESSSSS, see you soon!!";
